...
Use this reference when finalizing a `liang-relentless-brainstorm` session.
...
<body>
  <main class="page">
    ...
    <footer class="footer">
      Generated by liang-relentless-brainstorm. Treat this full report as private working notes unless intentionally shared.
    </footer>
  </main>
</body>
</html>
